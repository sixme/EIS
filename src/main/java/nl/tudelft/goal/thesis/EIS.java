...
public class EIS extends AbstractEnvironment {
    ...
    private boolean           naoOutput        = false;
    ...
    public void init(Map<String, Parameter> parameters) throws ManagementException {
        ...
        Parameter naoOutpt = parameters.get("naoOutput");
        if (naoOutpt != null && naoOutpt instanceof Identifier && ((Identifier) naoOutpt).getValue().equals("true")) {
            naoOutput = true;
        }
        try {
            System.out.println("NAOOutput is: " + naoOutput);
            registerEntity("entity1", new DialogManager(frame, naoOutput));
